 ...
 * Package: requests.js
 * 
 * Namespace: bbopx.minerva.requests
 * 
...
if ( typeof bbop.minerva == "undefined" ){ bbop.minerva = {}; }
 ...
 *  request object
 */
bbop.minerva.request = function(entity, operation){
    var anchor = this;
 ...
 *  request object
 */
bbop.minerva.request_set = function(user_token, intention){
    var anchor = this;
