...
bbopx.minerva.manager = function(barista_location, namespace, user_token, 
	...
	// //ind3_req.add_svf_expression('MGI:MGI:94925'); // Drd3
	// TODO/BUG: Nope--need Heiko.
	// ind3_req.add_complex_class_expression(
	//     new bbopx.noctua.edit.type({
	// 	'type': 'svf',
	// 	'literal': 'MGI:MGI:94925',
	// 	//'onProp': 'RO:0002333'
	// 	'onProperty': 'RO:0002333'
	//     }));
	// reqs.add(ind3_req);
