...
bbopx.minerva.class_expression = function(in_type, inferred_p){
    ...
    // 
    if( in_type ){
	if( what_is(in_type) == 'string' ){
	    anchor.as_class(in_type);
	}else{
 ...
 *  self
 */
bbopx.minerva.class_expression.prototype.as_simple_svf = function(
