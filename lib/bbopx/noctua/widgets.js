...
bbopx.noctua.widgets.repaint_info = function(ecore, aid, info_div){
    ...
    var eds = bbop.core.get_keys(ecore.all_edges()) || [];
 ...
 * them.
 */
bbopx.noctua.widgets.enode_types_to_stack = function(enode_types, aid){
...
bbopx.noctua.widgets.edit_node_modal = function(ecore, manager, enode,
    ...
    var each = bbop.core.each;
    var tag = bbop.html.tag;
    var enode_types_to_stack = bbopx.noctua.widgets.enode_types_to_stack;
